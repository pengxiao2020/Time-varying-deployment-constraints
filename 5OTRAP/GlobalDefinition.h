...
#define EcsInfoFile "../data/2RandomSampling/exp3/EcsInfo_9_0_1/data_EcsInfo_9_0_1.txt"	//基站信息

//根据不用的实验要求，需要修改存放“车辆任务信息”的路径和文件名，如：
//车辆 可连接矩阵 和 其余车辆属性 分开保存（读入的车辆信息小于 20000 条）
#define RS_CarInfoFile_S "../data/2RandomSampling/exp3/EcsInfo_9_0_1/data_RS_CarInfo_S_10000-" + to_string(ExeNum) + ".txt"	//小型车辆任务信息
#define RS_CarInfoFile_S_CM "../data/2RandomSampling/exp3/EcsInfo_9_0_1/data_RS_Car_CM_S_10000-" + to_string(ExeNum) + ".txt"	//小型车辆可连接矩阵(时变部署约束矩阵)
...
#define RS_CarInfoFile_L "../data/2RandomSampling/exp2/data_CarInfo_50%_5000_0_5000/data_RS_CarInfo_L_5000-" + to_string(ExeNum) + ".txt"	//大型车辆任务信息
#define RS_CarInfoFile_L_CM "../data/2RandomSampling/exp2/data_CarInfo_50%_5000_0_5000/data_RS_Car_CM_L_5000-" + to_string(ExeNum) + ".txt"	//大型车辆可连接矩阵(时变部署约束矩阵)
