...
void SaveResult()
{
	...
	// 保存算法 OTRAP 的求解结果
	string OTRAP_SolutionFile = "../data/ExperimentalResult/exp3/5OTRAP_Solution/EcsInfo_9_0_1/OTRAP_Solution_CarInfo_" + to_string(S_CarNum) + "_" + to_string(M_CarNum) + "_" + to_string(L_CarNum) + "-" + to_string(ExeNum) + ".txt";
